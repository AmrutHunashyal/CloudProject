...
li {display:inline;}
  ...
  <body bgcolor="lightskyblue">
      <form action="databasefordeletecources.php" method="post" name="course">
    ...
    <li> <a href="login.php" align="center">LOGOUT</a></li>
          ...
          <table style="margin-top: 0px;">
              <tr>
                  ...
                  <td width="1000" height="400" bgcolor="green" style=" color:  white; font-size: 20">
                      <p style="margin-left:180px; font-size: 30px; color:  white">DELETE COURSES</p>
           <p style="margin-left:130px;">COURSE-ID *  &nbsp; &nbsp; &nbsp;
         <input type="text" name="courseid"></p>
        <input type="submit" value="DELETE" style="margin-left: 220px; font-size: 15px;">
                  </td>
              </tr>
          </table>
