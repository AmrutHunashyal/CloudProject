	...
	xmlhttp.onreadystatechange=function()
	  {
		...
		xmlhttp.open("GET","ajax_count2.php?Q_no="+b+"&Ans="+a,false);
		xmlhttp.send();
	...
	xmlhttp.onreadystatechange=function()
	  {
		...
		xmlhttp.open("GET","ajax_submit2.php",false);
		xmlhttp.send();
	}
    </script>
    <style type="text/css">
...
li {display:inline;}
  ...
  <body bgcolor="lightskyblue">
    ...
    <li> <a align="center">TECHNICAL TEST</a></li>
    <li> <a href="login.php" align="center">LOGOUT</a></li>
    </ul>
 <br>
<p style="margin-left:600px; font-size: 30px; color: red"><b>TECHNICAL TEST</b></p>
...
<?php
include 'index.php';
$query = "SELECT questionno,question,option1,option2,option3,option4 FROM technical ORDER BY RAND() LIMIT 0,20";
