...
function coursedispaly()
{
window.location.replace("addcourses.php");
}
</script>
    <style type="text/css">
        .one2
...
li {display:inline;}
  ...
  <body bgcolor="lightskyblue">
      <form action="" method="post" name="coursedisplay">
    ...
    <li> <a align="center">COURCES INFORMATION</a></li>
    <li> <a href="login.php" align="center">LOGOUT</a></li>
</ul>
  <br>
        <table align="center" border=1  cellpadding=10px cellspacing=1px width="1000">
<tr>
<th>COURSE-ID
<th> COURSE-NAME
<th> CRITERIA
