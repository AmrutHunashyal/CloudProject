...
function insert()
{
window.location.replace("databaseforplacement.php");
}
    </script>
<style>
div
...
li {display:inline;}
  ...
  <body bgcolor="lightskyblue">
      <form action="databaseforplacement.php" method="post" name="login">
    ...
    <li> <a href="technicaltalks.php" align="center">TECHNICAL TALKS</a></li>
          ...
          <table bgcolor="lightgreen" border="1">
              <tr>
                  <td width="500" height="400">
                   <img src="grade.jpg"  align="left" width="500" height="400">
                  </td>
                  <td width="1000" height="400" style=" color:  black; font-size: 20">
                   <p style="margin-left:100px; font-size: 30px; color:  black">ADD COMPANY VISITING INFORMATION</p>
                   <p style="margin-left:80px;">SL NO. * &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;  &nbsp; &nbsp;  &nbsp;
                         <input type="text" name="no" size="40px"></p>
                     <p style="margin-left:80px;">COMPANY TYPE *  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                         <select name="type">
                             <option value="-1">&nbsp; &nbsp; Select  The Company Type &nbsp; &nbsp;</option>
                             <option>
                                 IT Compines
                             </option>
                             <option>
                      ...
                      <p style="margin-left:80px;">COMPANY NAME *  &nbsp;&nbsp; &nbsp;&nbsp;  &nbsp; &nbsp;  &nbsp;
                         <input type="text" name="companyname" size="40px"></p>
                       <p style="margin-left:80px;">DATE *   &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                         &nbsp; &nbsp;<input type="text" name="date1" size="40px"></p>
                       <p style="margin-left:80px;">TIME * &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                           <input type="text" name="time1" size="40px"></p>
                       <br>
                       <input type="submit" value=" Submit " style="margin-left: 250px; font-size: 15px;" onclick="insert()">
                  </td>
              </tr>
          </table>
